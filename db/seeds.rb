...
p22 = Pulse.create!(fake_votes: 707, title: "Installer un parc à chien", problem: "aaa", solution: "Créer un endroit pour pouvoir promener et éventuellement déposer son chien pour la journée", photo_url: 'https://images.unsplash.com/photo-1619333774340-3a878585c2e4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=686&q=80', address: 'lille', city_id: lille.id , user_id: jp.id)
# marseille
