...
p2 = Pulse.create!(title: "Créer de nouvelles pistes cyclables", solution: "Sensibiliser les automobilistes à la présence de cyclistes, faire de nouvelles pistes cyclables et mieux les baliser.", problem: "Je ne me sens pas en sécurité lorsque je roule a vélo dans Paris.", photo_url: 'https://images.unsplash.com/photo-1602148740250-0a4750e232e9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTR8fGJpa2V8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60', address: '10 faubourg Strasbourg Saint-Denis, 75010 paris', city_id: paris.id , user_id: felix.id)
p3 = Pulse.create!(title: "Créer une piscine dans la Seine", solution: "Créer un bassin modulable selon la saison avec peut-être un système de filtre pour assainir l'eau?", problem: "J'aimerai pouvoir me baigner dans la Seine mais c'est dansgereux et l'eau n'est pas propre", photo_url: 'https://images.unsplash.com/photo-1487452066049-a710f7296400?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fHVyYmFufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60', address: '3 place de la Republique, 75011 paris', city_id: paris.id , user_id: felix.id)
# st malo
