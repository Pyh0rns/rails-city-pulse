...
manu = User.create!(email: "mm@gmail.com", password: "azerty", xp: 0, bio: "Echilada lover! J'adore me promener en ville avec mon chien.", nickname: "Manu", city_id: stmalo.id, grade: "", photo_url: "https://images.unsplash.com/photo-1542995719-06bfa52c0e11?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8c3F1YXJlJTIwcG9ydHJhaXR8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60")
...
marie = User.create!(email: "mar@gmail.com", password: "azerty", xp: 0, bio: "Toujours à vélo, j'espère pouvoir voter pour des idées qui permettent d'améliorer la mobilité urbaine :)", nickname: "Marie", pro: true, city_id: lille.id, grade: "", photo_url: "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8cG9ydHJhaXR8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60")
puts "User ok..."
...
PulseCategory.create!(pulse_id: p12.id, category_id: sante.id)
PulseCategory.create!(pulse_id: p12.id, category_id: urbanisme.id)
PulseCategory.create!(pulse_id: p12.id, category_id: ecologie.id)
